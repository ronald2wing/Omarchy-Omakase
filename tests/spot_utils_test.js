...
assert("priceSortKey range price", M.priceSortKey({price:"68-150"}) === 68);
...
assert("formatCoursesSegment omakase courses kept", M.formatCoursesSegment({courses:"20"}) === "20 courses");
assert("formatCoursesSegment non-ayce discount_window kept", M.formatCoursesSegment({discount_window:"8pm"}) === "from 8pm");
assert("formatCoursesSegment null", M.formatCoursesSegment(null) === "");
