...
Rectangle {
  ...
  property int zebraStripeIndex     // 0 or 1 for zebra striping (ignored when hover)
  ...
  color: card.useHoverBg ? (card.hovered ? panel.cardHoverBackground : panel.cardBackground) : (card.zebraStripeIndex ? panel.cardBackground : panel.foregroundAlpha(0.03))
  ...
  Rectangle {
    ...
    width: Style.space(4); radius: Style.space(2)
  ...
  Rectangle {
    ...
    Image {
      ...
      // decoded per card.
      sourceSize.width: Style.space(48) * 2
      sourceSize.height: Style.space(48) * 2
  ...
  Loader {
    ...
    sourceComponent: Component {
      RatingEditor {
        panel: card.panel; spotName: card.spotName; cityKey: card.cityKey
