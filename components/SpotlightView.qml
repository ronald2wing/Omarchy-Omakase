...
Column {
  ...
  Row {
    ...
    BackLink {
      ...
      onClicked: {
        spotlightView.panel.spotlight = false;
        spotlightView.panel.expandedSpotName = null;
        // Typing in the shared field cleared the dismissal, so leaving the view
        // must dismiss again or the dropdown surfaces over the tab list.
        spotlightView.panel.searchSuggestionsDismissed = true;
      }
    }
