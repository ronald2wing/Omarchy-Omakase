...
#   location — Yelp search location string (collect_cities + refresh_yelp_fields)
#   name     — display name
#   currency — ISO currency code (collect_cities)
#   center   — [lat, lon] city center (radius guard in collect_cities, batch nearby
...
CITIES = {
  ...
  'chicago' => { location: 'Chicago, IL, USA', name: 'Chicago', currency: 'USD', center: [41.8781, -87.6298] },
  ...
  'kyoto' => { location: 'Kyoto, Japan', name: 'Kyoto', currency: 'JPY', center: [35.0116, 135.7681] },
  'las-vegas' => { location: 'Las Vegas, NV, USA', name: 'Las Vegas', currency: 'USD', center: [36.1699, -115.1398] },
  'lisbon' => { location: 'Lisbon, Portugal', name: 'Lisbon', currency: 'EUR', center: [38.72, -9.14] },
  'london' => { location: 'London, UK', name: 'London', currency: 'GBP', center: [51.5074, -0.1278] },
  'los-angeles' => { location: 'Los Angeles, CA, USA', name: 'Los Angeles', currency: 'USD',
  ...
  'osaka' => { location: 'Osaka, Japan', name: 'Osaka', currency: 'JPY', center: [34.6937, 135.5023] },
  'paris' => { location: 'Paris, France', name: 'Paris', currency: 'EUR', center: [48.8566, 2.3522] },
  ...
  'seoul' => { location: 'Seoul, South Korea', name: 'Seoul', currency: 'KRW', center: [37.5665, 126.9780] },
  ...
  'tokyo' => { location: 'Tokyo, Japan', name: 'Tokyo', currency: 'JPY', center: [35.6762, 139.6503] },
  'toronto' => { location: 'Toronto, ON, Canada', name: 'Toronto', currency: 'CAD', center: [43.6532, -79.3832] },
  'vancouver' => { location: 'Vancouver, BC, Canada', name: 'Vancouver', currency: 'CAD',
...
# Cities collect_cities can collect, derived from collectable? — not hand-listed,
